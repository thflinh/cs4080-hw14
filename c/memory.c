...
//< Methods and Initializers mark-methods
      ...
      markTable(&klass->declaredFields);
      break;
    }
//< Classes and Instances blacken-class
//> blacken-closure
...
//> blacken-function
    case OBJ_FUNCTION: {
      ...
      InvokeCache* ic = &function->chunk.invokeCaches;
      for (int i = 0; i < ic->count; i++) {
        InvokeCacheEntry* e = &ic->entries[i];
        markObject((Obj*)e->klass);
        markObject((Obj*)e->method);
        markObject((Obj*)e->owner);
...
//> Methods and Initializers free-methods
      ...
      freeTable(&klass->declaredFields);
//< Methods and Initializers free-methods
